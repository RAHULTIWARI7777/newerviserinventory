...
export const EMPLOYEE_GET_URL = '/Employee/Get'; // Modify this according to your backend
export const EMPLOYEE_CREATE_URL = '/Employee/Create'; // Modify this according to your backend

export const INVENTORY_GET_URL = '/HardwareInfo/Get'; // Modify this according to your backend
export const INVENTORY_CREATE_URL = '/HardwareInfo/Create'; // Modify this according to your backend
